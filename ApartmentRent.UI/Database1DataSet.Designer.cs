...
namespace ApartmentRent.UI {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsersRow AddUsersRow(string login, string password, string fullname, string phone, string Company) {
...
namespace ApartmentRent.UI.Database1DataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Users] WHERE (([Id] = @Original_Id) AND ((@IsNull_login = 1 AND [login] IS NULL) OR ([login] = @Original_login)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_fullname = 1 AND [fullname] IS NULL) OR ([fullname] = @Original_fullname)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Users] ([login], [password], [fullname], [phone], [Company]) VALUES " +
                "(@login, @password, @fullname, @phone, @Company);\r\nSELECT Id, login, password, f" +
                "ullname, phone, Company FROM Users WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Users] SET [login] = @login, [password] = @password, [fullname] = @fullname, [phone] = @phone, [Company] = @Company WHERE (([Id] = @Original_Id) AND ((@IsNull_login = 1 AND [login] IS NULL) OR ([login] = @Original_login)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_fullname = 1 AND [fullname] IS NULL) OR ([fullname] = @Original_fullname)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)));
SELECT Id, login, password, fullname, phone, Company FROM Users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ApartmentRent.UI.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, login, password, fullname, phone, Company FROM Users";
        ...
        public virtual int Delete(int Original_Id, string Original_login, string Original_password, string Original_fullname, string Original_phone, string Original_Company) {
        ...
        public virtual int Insert(string login, string password, string fullname, string phone, string Company) {
            if ((login == null)) {
        ...
        public virtual int Update(string login, string password, string fullname, string phone, string Company, int Original_Id, string Original_login, string Original_password, string Original_fullname, string Original_phone, string Original_Company, int Id) {
            if ((login == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string login, string password, string fullname, string phone, string Company, int Original_Id, string Original_login, string Original_password, string Original_fullname, string Original_phone, string Original_Company) {
            return this.Update(login, password, fullname, phone, Company, Original_Id, Original_login, Original_password, Original_fullname, Original_phone, Original_Company, Original_Id);
        }
    }
